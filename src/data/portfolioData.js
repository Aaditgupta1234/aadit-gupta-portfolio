...
export const projectsData = [
  {
    ...
    tagline: "Explainable AI Business Diagnosis Platform",
    description:
      "Analyzes company datasets, generates KPIs, identifies root causes of performance changes, provides recommendations, and produces executive-level intelligence reports.",
    highlights: [
      "KPI Engine",
      "Root Cause Analysis",
  ...
  },
  {
    ...
    tagline: "Premium Digital Library Platform",
    description:
      "Production-grade digital library platform featuring authentication, RBAC, reservations, reviews, inventory management, and modern reading experiences.",
    highlights: [],
    tech: ["React", "Node.js", "PostgreSQL", "Prisma", "JWT", "Supabase"],
    links: {
      demo: "#",
      github: "#",
    },
